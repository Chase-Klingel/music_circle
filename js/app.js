((() => {
  ...
  const $p8 = $('<p class="about"><span>Valuable customer feedback:</span> The most important lesson I learned in this project was GET USER FEEDBACK. My project was stale and boring before I showed a few people and having them give me that honest feedback was incredibly valuable. One classmate gave me the idea to add a carousel feature and I ended up finding the 3d carousel, which I felt added greatly to the user experience in the end.</p><br>');
  ...
  const $goals = $('<ol class="about goals-list"><h4 class="goals">Stretch Goals</h4><li>Output playlists based on user’s mood</li><li>Continuous streaming</li><li>Display "now playing: artist name - song name" in an easy to locate area</li><li>Easily accessible play, pause, next and previous buttons</li></ol><br>')
